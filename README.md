...
承認済みの落ち着いたノーマルのみです。VVM 内の他 Style は公開しません。
...
ずんだもんは `ApprovedVoices.SHOW_ZUNDAMON` で非表示にできます。
...
2. 話者を選ぶ（キャラクター音声または VOICEVOX Nemo）
...
- WhiteCUL / 四国めたん / ずんだもん / 春日部つむぎ / 雨晴はう / 玄野武宏 / 剣崎雌雄：公式のクレジット表記があれば商用・非商用で利用可能
- VOICEVOX Nemo：クレジット `VOICEVOX Nemo` があれば商用・非商用で利用可能
